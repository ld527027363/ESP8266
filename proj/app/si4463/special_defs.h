 ...
 * \n    -Updated Hi-Tech SI4463_INTERRUPT and SI4463_INTERRUPT_USING macro definitions
 * \n    -Added SFR16 macro defintion for Hi-Tech
 * \n Release 1.8 - 31 JUL 2008 (ES)
 * \n    -Added SI4463_INTERRUPT_USING and FUNCTION_USING macro's
 ...
 * \n    -Added SI4463_INTERRUPT_PROTO_USING to properly support ISR context switching
 *      under SDCC.
 * \n Release 1.2 - (BW)
 * \n    -Added support for U8,U16,U32,S8,S16,S32,UU16,UU32 data types
 * \n Release 1.1 - (BW)
 * \n    -Added support for SI4463_INTERRUPT, SI4463_INTERRUPT_USING, SI4463_INTERRUPT_PROTO,
...
#if (SDCC < 300)
# define SI4463_INTERRUPT(name, vector) void name (void) interrupt (vector)
# define SI4463_INTERRUPT_USING(name, vector, regnum) void name (void) interrupt (vector) using (regnum)
# define SI4463_INTERRUPT_PROTO(name, vector) void name (void) interrupt (vector)
# define SI4463_INTERRUPT_PROTO_USING(name, vector, regnum) void name (void) interrupt (vector) using (regnum)
...
#else //SDCC >= 300
# define SI4463_INTERRUPT(name, vector) void name (void) __interrupt (vector)
# define SI4463_INTERRUPT_USING(name, vector, regnum) void name (void) __interrupt (vector) using (regnum)
# define SI4463_INTERRUPT_PROTO(name, vector) void name (void) __interrupt (vector)
# define SI4463_INTERRUPT_PROTO_USING(name, vector, regnum) void name (void) __interrupt (vector) using (regnum)
# define FUNCTION_USING(name, return_value, parameter, regnum) return_value name (parameter) using (regnum)
# define FUNCTION_PROTO_USING(name, return_value, parameter, regnum) return_value name (parameter) using (regnum)
// Note: Parameter must be either 'void' or include a variable type and name. (Ex: char temp_variable)
# define SEGMENT_VARIABLE(name, vartype, locsegment) locsegment vartype name
...
# define SI4463_INTERRUPT(name, vector) void name (void) interrupt vector
# define SI4463_INTERRUPT_USING(name, vector, regnum) void name (void) interrupt vector using regnum
# define SI4463_INTERRUPT_PROTO(name, vector) void name (void)
# define SI4463_INTERRUPT_PROTO_USING(name, vector, regnum) void name (void)
...
# define SI4463_INTERRUPT(name, vector)       void name (void) interrupt vector
# define SI4463_INTERRUPT_PROTO(name, vector)
# define SI4463_INTERRUPT_USING(name, vector, regnum) void name (void) interrupt vector using regnum
# define SI4463_INTERRUPT_PROTO_USING(name, vector, regnum)
...
# define SI4463_INTERRUPT(name, vector) _interrupt (vector) void name (void)
# define SI4463_INTERRUPT_USING(name, vector, regnum) _interrupt (vector) _using(regnum) void name (void)
# define SI4463_INTERRUPT_PROTO(name, vector) _interrupt (vector) void name (void)
# define SI4463_INTERRUPT_PROTO_USING(name, vector, regnum) _interrupt (vector) _using(regnum) void name (void)
...
# define SI4463_INTERRUPT(name, vector) _Pragma(_PPARAM_(vector)) __interrupt void name(void)
# define SI4463_INTERRUPT_PROTO(name, vector)  __interrupt void name(void)
# define SI4463_INTERRUPT_USING(name, vector, regnum) _Pragma(_PPARAM2_(regnum)) _Pragma(_PPARAM_(vector)) __interrupt void name(void)
# define SI4463_INTERRUPT_PROTO_USING(name, vector, regnum) __interrupt void name(void)
...
#define SI4463_INTERRUPT(name, vector) void name (void)
#define SI4463_INTERRUPT_USING(name, vector, regnum) void name (void)
#define SI4463_INTERRUPT_PROTO(name, vector) void name (void)
#define SI4463_INTERRUPT_PROTO_USING(name, vector, regnum) void name (void)
